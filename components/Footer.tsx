...
export default function Footer() {
  return (
    <footer className="max-w-6xl text-center h-16 sm:h-20 w-full sm:pt-2 pt-4 border-t mt-5 flex sm:flex-row flex-col justify-between items-center px-3 space-y-3 sm:mb-0 mb-3">
      <div>
        Powered by{" "}
        <a
      ...
      <div className="flex space-x-4 pb-4 sm:pb-0">
        {/* <Link
          ...
          className="group"
          aria-label="johanazhu on Twitter"
        >
          <svg
            aria-hidden="true"
